<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="CancelOrderStatus.aspx.cs" Inherits="User" %>
        ...
        <tr>
            ...
            <td class="style141">
                ...
                <asp:DropDownList ID="ddlStatus" runat="server" Height="17px" Width="164px">
                    <asp:ListItem>CancelOrder</asp:ListItem>
