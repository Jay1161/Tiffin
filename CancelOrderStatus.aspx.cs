...
public partial class User : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select InvoiceNo from DailyOrderInfo where  OrderBy=@p1 and Status=@p2 ", con);

            cmd.Parameters.AddWithValue("@p1", Session["Name"]);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        javaScript.Append("window.location='User.aspx';");
