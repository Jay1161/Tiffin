<%@ Page Title="User RegistRation Form" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QuickDistributorRegistration.aspx.cs" Inherits="PatientRegistRation" %>
        ...
        <tr>
            ...
            <td class="style143" colspan="2">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="eno" ErrorMessage="Enter 10 Digit Mobile No"></asp:RequiredFieldValidator>
            </td>
            <td class="style144">
            </td>
        </tr>
