<%@ Page Title="" Language="C#" MasterPageFile="~/DistributorMasterPage.master" AutoEventWireup="true" CodeFile="ViewDistributorOrderHistory.aspx.cs" Inherits="User" %>
        ...
        <tr>
            <td class="style134" colspan="2">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT DISTINCT * FROM [DailyOrderInfo] WHERE ([DistributorName] = @DistributorName)">
                    <SelectParameters>
                        <asp:SessionParameter Name="DistributorName" SessionField="DName" 
                            Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
